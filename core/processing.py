...
class Processor:
    def __init__(self, keywords, config, history_file='data/history.json', trend_file='data/sentiment_trends.json', today_news_file='data/today_news.json'):
    ...
    def filter_by_keywords(self, news_items):
        ...
        last_max_dt = twenty_four_hours_ago
